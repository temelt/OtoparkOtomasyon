 ...
 * 
 */
@WebServiceClient(name = "KPSPublic", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", wsdlLocation = "META-INF/wsdl/KPSPublic.wsdl")
    ...
    extends Service
{
    ...
    static {
        KPSPUBLIC_WSDL_LOCATION = tr.gov.nvi.tckimlik.ws.KPSPublic.class.getClassLoader().getResource("META-INF/wsdl/KPSPublic.wsdl");
        WebServiceException e = null;
        if (KPSPUBLIC_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/KPSPublic.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
